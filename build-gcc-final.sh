...
../../source/gcc-${GCCVER}/configure \
	...
	--disable-multilib --disable-libmudflap --disable-libgcj --disable-libssp --enable-lto \
	...
	--disable-coverage --disable-nls --disable-tls --with-newlib --disable-decimal-float \
